...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_pDoc=(CVTestDoc*)docTemp->GetNextDoc(pos2);
	...
	m_wndStatusBar.AddElement(&m_StatusText, L"Sẵn sàng");
	//m_wndStatusBar.AddExtendedElement(new CMFCRibbonStatusBarPane(ID_STATUSBAR_PANE2, strTitlePane2, TRUE), strTitlePane2);
	m_wndStatusBar.AddExtendedElement(&m_wndProg,L"P",0);
	m_pDoc->m_prog=&m_wndProg;
	m_pDoc->m_statusBar=&m_wndStatusBar;
	m_pDoc->m_statusText=&m_StatusText;
...
BOOL CMainFrame::CreateCaptionBar()
{
	...
	m_wndCaptionBar.SetButton(L"Test", ID_TOOLS_OPTIONS, CMFCCaptionBar::ALIGN_LEFT, FALSE);
	m_wndCaptionBar.SetButtonToolTip(L"TestTip");

	m_wndCaptionBar.SetText(L"Text", CMFCCaptionBar::ALIGN_LEFT);

	m_wndCaptionBar.SetBitmap(IDB_INFO, RGB(255, 255, 255), FALSE, CMFCCaptionBar::ALIGN_LEFT);
	
	m_wndCaptionBar.SetImageToolTip(L"Tip", L"Text");
